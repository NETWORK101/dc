...
| `docs/devto-social-brief.md` | Brief for Tomas Shepherd: dev.to set up for SEO, a daily X pipeline, other proven organic and social tactics, measurement, and the contributor and PR review flow for the brand repo. |
